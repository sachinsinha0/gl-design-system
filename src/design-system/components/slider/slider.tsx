...
import { SliderFrame, SliderImpl } from './slider-impl';
...
const SliderThumb = React.memo(
  SliderThumbFrame.styleable<SliderThumbExtraProps>(function SliderThumb(
    ...
    const composedRefs = useComposedRefs(forwardedRef, (node) => setThumb(node as TamaguiElement));
