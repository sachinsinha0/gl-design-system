...
export type DesignSystemDescriptor = {
  ...
  /**
   * Full app shell for this DS — mounts its own Provider, renders sidebar / search /
   * theme switcher / page header / scroll container, and puts `children` (the route
   * outlet) inside its content area. Each DS owns its native chrome.
   */
